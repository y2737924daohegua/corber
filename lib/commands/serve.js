...
var getPort     = rsvp.denodeify(PortFinder.getPort);
...
module.exports = Command.extend({
  ...
  startValidators: function(project, options) {
    ...
    validations.push(
      validateRootUrl.run(),
      validateLocationType.run(),
      validateAllowNavigation.run(),
