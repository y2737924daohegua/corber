const Framework        = require('ember-cordova/lib/frameworks/framework');
const Promise          = require('rsvp').Promise;
const logger           = require('ember-cordova/lib/utils/logger');

/*
 ember-cordova has pre-defined frameworks at ../frameworks/foo
